...
public:
	bool Init(int64_t machine_id, int64_t data_center_id)
	{
		...
		std::cout << "SnowFlake::Init success:m_machine_id=" << m_machine_id << ", m_data_center_id=" << m_data_center_id << std::endl;
		return true;
	}
...
protected:
	...
	int64_t m_data_center_id = 0;
	int64_t m_machine_id = 0;
